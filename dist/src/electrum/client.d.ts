...
declare class ElectrumClient extends SocketClient {
    connect(clientName: any, electrumProtocolVersion: any, persistencePolicy?: {
        maxRetry: number;
        callback: null;
    }): Promise<void>;
    persistencePolicy: {
...
import SocketClient = require("../socket/socket_client");
